...
Recipe.insertMany(data)
  ...
  .catch((error) => {
    console.error("Recipe is not insert the database: ", error);
  });

Recipe.findOneAndUpdate({ title: "Rigatoni alla Genovese" }, { duration: 100 })

  .then(() => console.log("Rigatoni alla Genovese recipe duration is updated."))
  .catch((error) => console.error(`Recipe can't be updated:`, error));
